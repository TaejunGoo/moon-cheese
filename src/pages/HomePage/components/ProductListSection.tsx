        ...
        <ProductItem.Root onClick={() => handleClickProduct(1)}>
          ...
          <ProductItem.Meta>
            <ProductItem.MetaLeft>
              ...
              <ProductItem.Price>{transCurrency(12.99)}</ProductItem.Price>
            </ProductItem.MetaLeft>
          </ProductItem.Meta>
          <Counter.Root>
        ...
        <ProductItem.Root onClick={() => handleClickProduct(2)}>
          ...
          <ProductItem.Meta>
            <ProductItem.MetaLeft>
              ...
              <ProductItem.Price>{transCurrency(5.0)}</ProductItem.Price>
            </ProductItem.MetaLeft>
        ...
        <ProductItem.Root onClick={() => handleClickProduct(3)}>
          ...
          <ProductItem.Meta>
            <ProductItem.MetaLeft>
              ...
              <ProductItem.Price>{transCurrency(7.0)}</ProductItem.Price>
            </ProductItem.MetaLeft>
